...
public class CustomMyBatisBatchItemWriter<T> implements ItemWriter<List<T>>, InitializingBean {
	 ...
	 * number of BatchResult objects returned is one and all items cause at least
	 * one row to be updated.
	 *
	 ...
	 *
	 * @param itemToParameterConverter a converter that converting item to parameter
	 *                                 object
	 * @since 2.0.0
	 */
