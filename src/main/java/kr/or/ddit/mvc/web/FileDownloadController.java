...
public class FileDownloadController {
	...
	// localhost:8081/file/fileDownloadView?userid=cony
	@RequestMapping("fileDownloadView")
	public String fileDownloadView(String userid,Model model) {
		//1. 다운로드 파일의 경로 ==> realFilename
		//2. 다운로드시에 보여줄 파일 명 ==> filename
		// 1, 2를 model에 넣어준다
		
		// userid 파라미터를 보낸다고 가정하고, 파라미터를 이용하여 해당 사용자의 사진 정보(realFilename, Filename) 조회하여 처리 
